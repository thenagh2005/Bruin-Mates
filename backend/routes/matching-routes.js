...
const { getAllAcceptedMatches, getAllPendingMatches, processMatchRequest, acceptMatchRequest, rejectMatchRequest, getMatchStatus, removeMatch } = require("../controllers/matching-controllers");
...
router.post('/remove-match/:id', verifyToken, removeMatch)
